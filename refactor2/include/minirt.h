...
void	pixel_put(t_scene *scene, char ***ppm_file);
...
t_color3	ray_color(t_scene *scene, char ***ppm_file);
t_ray		ray(t_point3 orig, t_vec3 dir);
t_point3	ray_at(t_ray *ray, double t);
t_bool		hit(t_object *object_list, t_ray *ray, t_hit_record *rec, char ***ppm_file);
t_bool		hit_obj(t_object *object_list, t_ray *ray, t_hit_record *rec, char ***ppm_file);
...
t_color3	phong_lighting(t_scene *scene, char ***ppm_file);
t_bool		in_shadow(t_scene *scene, t_vec3 light_vec, char ***ppm_file);
...
t_color3	point_light_get(t_scene *scene, t_light *light, char ***ppm_file);
